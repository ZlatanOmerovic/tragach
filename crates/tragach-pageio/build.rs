// Fourth copy of this — the duplication is real, and is exactly the kind of
// "lift into a shared build helper" the third copy already flagged in attach's
// build.rs. Not in this PR's scope.
